...
async function loadModel2() {
    const modelUrl = 'https://raw.githubusercontent.com/sarah12121212/Stamp-Scan/refs/heads/main/docs/allpanels2_mobilenet/model.json';
...
wrongButton.addEventListener("click", function() {
    ...
    top10.forEach(entry => {
        ...
        image.onerror = function () {
            ...
            image.onerror = function () {
                console.log("Loading from classimages instead of images");
                image.src = `classimages/${classes[entry.index]}.jpg`;
                console.log(`classimages/${classes[entry.index]}.jpg`);
...
img.onerror = function () {
    ...
    img.onerror = function () {
        console.log("Loading from classimages instead of images");
        img.src = `classimages/${predictedClass}.jpg`;
